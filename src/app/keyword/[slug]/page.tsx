...
export default function KeywordDetailPage({ params }: { params: { slug: string } }) {
  ...
  return (
    <main className="detail-page">
      ...
      <section>
        <h2>바로 쓰는 블로그 제목 템플릿</h2>
        <p className="section-hint">제목을 클릭하면 AI가 본문과 추천 이미지를 생성합니다.</p>
        <ArticleGenerator slug={keyword.slug} titleTemplates={keyword.titleTemplates} />
      </section>
